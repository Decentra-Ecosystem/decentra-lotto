...
@Component({
  selector: 'app-marsecosystem',
  templateUrl: './marsecosystem.component.html',
  styleUrls: ['./marsecosystem.component.css']
})
export class MarsecosystemComponent implements OnInit {
