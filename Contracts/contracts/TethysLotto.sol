...
// contract DecentraTokens is Context, IERC20, Ownable {
...
//     //token config
//     string private _name = "Metis Lotto";
//     string private _symbol = "METWIN";
//     uint8 private _decimals = 9;

//     uint256 public _taxFee = 1;
//     uint256 private _previousTaxFee = _taxFee;

//     uint256 public _jackpotFee = 7;
//     uint256 private _previousJackpotFee = _jackpotFee;

//     uint256 public _marketingDevFee = 6;
//     uint256 private _previousmarketingDevFee = _marketingDevFee;

//     uint256 public _percentOfSwapIsLotto = 25;
//     uint256 public _percentOfSwapIsMarketing = 25;
...
//     constructor (address router, address devWallet, address marketingWallet, address jackpotTokenAddress_IN, uint8 jackpotTokenDecimals_IN, uint256 lottoJackpotAmount_IN) public {
...
//         _marketingDevFee = ecosystemLottoDevFee;
//     }
...
//         return _amount*(_marketingDevFee)/(
//             10**2
//         );
//     }

//     function removeAllFee() private {
//         if(_taxFee == 0 && _marketingDevFee == 0 && _jackpotFee == 0) return;

//         _previousTaxFee = _taxFee;
//         _previousJackpotFee = _jackpotFee;
//         _previousmarketingDevFee = _marketingDevFee;
...
//         _marketingDevFee = _previousmarketingDevFee;
//     }
...
//                 lottoOn
//             ) {
//                 _changeState(LotteryState.Drawing);
//                 requestId = drawWinner();
...
//         return uint256(keccak256(abi.encodePacked(block.difficulty, block.timestamp, seed)) % numAddresses);
//     }

//     function drawWinner() private {
//         //seed for abi encoding random number
//         uint32 seed = block.timestamp % numAddresses;
...
//         //get the percentage split for dev, and Lotto
...
//         //send ETH to marketing, and dev
//         _marketingWallet.transfer(marketingETHAmount);
//         _devWallet.transfer(deltaBalance-jackpotETHAmount-marketingETHAmount);

//         emit SwapAndDistribute(contractTokenBalance, jackpotETHAmount, deltaBalance-jackpotETHAmount-marketingETHAmount);
//     }
