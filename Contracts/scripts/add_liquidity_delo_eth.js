...
const address = '0xe19C8be60a8093Cf65Ec742D05e35cc20D7FE535';
const amtETH = '4000000000000000000'; //4eth
const tokenPercentsupply = 5; //5%
...
async function main() {
  ...
  if (isTest == true){
    ...
    deployerKey = secrets.deloDevLive
